class Admin {
    ...
    var db = new DB("Formular");
            ...
            if (key) {
                ...
                db.getRow(key, "Formular").then((resolve) => {
                    ...
                    if (resolve) {
                        ...
                        //Show the result
                        for (var i:any = 0; i < resolve.values.length; i++) {
        ...
        //on choosing radio
        $("body").on("change", ".select_input_type", (event) => {
        ...
        $("#save").on("click", () => {
            ...
            for (var i = 0; i < this.count; i++) { //colecting the data for IndexedDB
        ...
        $("body").on("click", "#update", () => {
            ...
            if (dataToSave.values.length > 0) {
                ...
                db.getRow(search, "Formular").then((resolve) => {
